...
namespace pkNX.Structures.FlatBuffers
{
    ...
    {
        [FlatBufferItem(00)] public PlacementZone8FieldItem Field_00 { get; set; }
    }
    ...
    public class PlacementZone8FieldItem
    {
        ...
        [FlatBufferItem(06)] public ulong[] Flags { get; set; }
        [FlatBufferItem(07)] public uint[] Items { get; set; }
