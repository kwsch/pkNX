...
public class PokeFieldObstructionWazaNsLegendEffectArchive8a : IFlatBufferArchive<PokeFieldObstructionWazaNsLegendEffect8a>
{
    public byte[] Write() => FlatBufferConverter.SerializeFrom(this);

    [FlatBufferItem(00)] public PokeFieldObstructionWazaNsLegendEffect8a[] Table { get; set; } = Array.Empty<PokeFieldObstructionWazaNsLegendEffect8a>();
}

[FlatBufferTable, TypeConverter(typeof(ExpandableObjectConverter))]
public class PokeFieldObstructionWazaNsLegendEffect8a
{
