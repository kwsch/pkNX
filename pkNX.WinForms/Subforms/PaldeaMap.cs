...
public class PaldeaMap
{
    ...
    public PaldeaMap(GameManagerSV ROM)
    {
        ...
        FieldLocations[2] = []; // FlatBufferConverter.DeserializeFrom<FieldLocationArray>(ROM.GetPackedFile("world/data/field/area_su2/field_location_su2/field_location_su2_array.bin")).Table;
