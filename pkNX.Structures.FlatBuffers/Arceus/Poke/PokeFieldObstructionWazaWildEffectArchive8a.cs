...
public class PokeFieldObstructionWazaWildEffectArchive8a : IFlatBufferArchive<PokeFieldObstructionWazaWildEffect8a>
{
    public byte[] Write() => FlatBufferConverter.SerializeFrom(this);

    [FlatBufferItem(00)] public PokeFieldObstructionWazaWildEffect8a[] Table { get; set; } = Array.Empty<PokeFieldObstructionWazaWildEffect8a>();
}

[FlatBufferTable, TypeConverter(typeof(ExpandableObjectConverter))]
public class PokeFieldObstructionWazaWildEffect8a
{
