...
public class PersonalDumperSV
{
    ...
    private void AddLearnsets(PersonalInfo9SVfb fb, List<string> lines, string specCode)
    {
    ...
    private void AddEvolutions(PersonalInfo9SVfb fb, List<string> lines)
    {
