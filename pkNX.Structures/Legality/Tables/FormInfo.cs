...
public static class FormInfo
{
    ...
    public static string[] GetOutOfBattleFormNames(ushort species)
    {
        return species switch
        {
            (int)Rattata => new[] {"", "Alolan "},
            (int)Raticate => new[] {"", "Alolan "},
            (int)Pikachu => new[] {"Capless ", "Cap 1 ", "Cap 2 ", "Cap 3 ", "Cap 4 ", "Cap 5 ", "Cap 6 ", "Cap 7 ", "Cap 8 ", "Cap 9 "},
            (int)Raichu => new[] {"", "Alolan "},
            (int)Sandshrew => new[] {"", "Alolan "},
            (int)Sandslash => new[] {"", "Alolan "},
            (int)Vulpix => new[] {"", "Alolan "},
            (int)Ninetales => new[] {"", "Alolan "},
            (int)Diglett => new[] {"", "Alolan "},
            (int)Dugtrio => new[] {"", "Alolan "},
            (int)Meowth => new[] {"", "Alolan ", "Galarian "},
            (int)Persian => new[] {"", "Alolan "},
            (int)Growlithe => new[] {"", "Hisuian "},
            (int)Arcanine => new[] {"", "Hisuian "},
            (int)Geodude => new[] {"", "Hisuian "},
            (int)Graveler => new[] {"", "Hisuian "},
            (int)Golem => new[] {"", "Hisuian "},
            (int)Ponyta => new[] {"", "Galarian "},
            (int)Rapidash => new[] {"", "Galarian "},
            (int)Slowpoke => new[] {"", "Galarian "},
            (int)Slowbro => new[] {"", "Galarian "},
            (int)Farfetchd => new[] {"", "Galarian "},
            (int)Grimer => new[] {"", "Alolan "},
            (int)Muk => new[] {"", "Alolan "},
            (int)Voltorb => new[] {"", "Hisuian "},
            (int)Electrode => new[] {"", "Hisuian "},
            (int)Exeggutor => new[] {"", "Alolan "},
            (int)Marowak => new[] {"", "Alolan "},
            (int)Weezing => new[] {"", "Galarian "},
            (int)MrMime => new[] {"", "Galarian "},
            (int)Articuno => new[] {"", "Galarian "},
            (int)Zapdos => new[] {"", "Galarian "},
            (int)Moltres => new[] {"", "Galarian "},
            (int)Typhlosion => new[] {"", "Hisuian "},
            (int)Slowking => new[] {"", "Galarian "},
            (int)Unown => new[] {"A ", "B ", "C ", "D ", "E ", "F ", "G ", "H ", "I ", "J ", "K ", "L ", "M ", "n  ", "O ", "P ", "Q ", "R ", "S ", "T ", "U ", "V ", "W ", "X ", "Y ", "Z ", "Exclamation ", "Question "},
            (int)Sneasel => new[] {"", "Hisuian "},
            (int)Corsola => new[] {"", "Galarian "},
            (int)Zigzagoon => new[] {"", "Galarian "},
            (int)Linoone => new[] {"", "Galarian "},
            (int)Castform => new[] {"Normal ", "Sunny ", "Rainy ", "Snowy "},
            (int)Burmy => new[] {"Plant Cloak ", "Sandy Cloak ", "Trash Cloak "},
            (int)Wormadam => new[] {"Plant Cloak ", "Sandy Cloak ", "Trash Cloak "},
            (int)Shellos => new[] {"West Sea ", "East Sea "},
            (int)Gastrodon => new[] {"West Sea ", "East Sea "},
            (int)Rotom => new[] {"", "Heat Rotom ", "Wash Rotom ", "Frost Rotom ", "Fan Rotom ", "Mow Rotom "},
            (int)Dialga => new[] {"", "Origin "},
            (int)Palkia => new[] {"", "Origin "},
            (int)Giratina => new[] {"", "Origin "},
            (int)Shaymin => new[] {"Land ", "Sky "},
            (int)Samurott => new[] {"", "Hisuian "},
            (int)Lilligant => new[] {"", "Hisuian "},
            (int)Basculin => new[] {"Red-Striped ", "Blue-Striped ", "White-Striped "},
            (int)Darumaka => new[] {"", "Galarian "},
            (int)Darmanitan => new[] {"", "Galarian non-Zen "},
            (int)Yamask => new[] {"", "Galarian "},
            (int)Zorua => new[] {"", "Hisuian "},
            (int)Zoroark => new[] {"", "Hisuian "},
            (int)Deerling => new[] {"Spring ", "Summer ", "Autumn ", "Winter "},
            (int)Sawsbuck => new[] {"Spring ", "Summer ", "Autumn ", "Winter "},
            (int)Braviary => new[] {"", "Hisuian "},
            (int)Tornadus => new[] {"Incarnate ", "Therian "},
            (int)Thundurus => new[] {"Incarnate ", "Therian "},
            (int)Landorus => new[] {"Incarnate ", "Therian "},
            (int)Kyurem => new[] {"Normal ", "Black ", "White "},
            (int)Keldeo => new[] {"Ordinary ", "Resolute "},
            (int)Meloetta => new[] {"Aria ", "Pirouette "},
            (int)Genesect => new[] {"Normal ", "Electric ", "Fire ", "Ice ", "Water "},
            (int)Flabébé => new string[] { "Red Flower ", "Yellow Flower ", "Orange Flower ", "Blue Flower ", "White Flower " },
            (int)Floette => new string[] { "Red Flower ", "Yellow Flower ", "Orange Flower ", "Blue Flower ", "White Flower " },
            (int)Florges => new string[] { "Red Flower ", "Yellow Flower ", "Orange Flower ", "Blue Flower ", "White Flower " },

            // (int)Aegislash => new string[] { "Sword ", "Shield " },
            (int)Sliggoo => new string[] { "", "Hisuian " },
            (int)Goodra => new string[] { "", "Hisuian " },
            (int)Avalugg => new string[] { "", "Hisuian " },
            (int)Zygarde => new string[] { "Form 0 ", "Form 1 ", "Form 2 ", "Form 3 ", "Complete " },

            (int)Decidueye => new string[] { "", "Hisuian " },
            (int)Oricorio => new string[] { "Baile Style ", "Pom-Pom Style ", "Pa'u Style ", "Sensu Style " },
            (int)Lycanroc => new string[] { "Midday ", "Midnight ", "Dusk " },

            // (int)Wishiwashi => new string[] { "Solo ", "School " },
            (int)Silvally => new string[] { "Normal Type ", "Fire Type ", "Water Type ", "Electric Type ", "Grass Type ", "Ice Type ", "Fighting Type ", "Poison Type ", "Ground Type ", "Flying Type ", "Psychic Type ", "Bug Type ", "Rock Type ", "Ghost Type ", "Dragon Type ", "Dark Type ", "Steel Type ", "Fairy Type " },
            (int)Minior => new string[] { "Meteor 0 ", "Meteor 1 ", "Meteor 2 ", "Meteor 3 ", "Meteor 4 ", "Meteor 5 ", "Meteor 6 ", "Meteor 7 ", "Core 0 ", "Core 1 ", "Core 2 ", "Core 3 ", "Core 4 ", "Core 5 ", "Core 6 ", "Core 7 " },
            (int)Mimikyu => new string[] { "", "Totem Disguise " },
            (int)Necrozma => new string[] { "", "Dusk Mane ", "Dawn Wings " },

            (int)Toxtricity => new string[] { "Amped ", "Low Key " },
            (int)Urshifu => new string[] { "Single Strike Style ", "Rapid Strike Style " },

            (int)Calyrex => new string[] { "", "Ice Rider ", "Shadow Rider " },

            (int)Enamorus => new string[] { "Incarnate ", "Therian "},
    ...
    /// <summary>
    /// Checks if the <see cref="form"/> exists for the <see cref="species"/> without having an associated personal info index.
    /// </summary>
    /// <param name="species">Entity species</param>
    /// <param name="form">Entity form</param>
    /// <param name="format">Current generation format</param>
    ...
    /// <summary>
    /// Checks if the entity data should have a drop-down selection visible for the form value.
    /// </summary>
    /// <param name="pi">Game specific personal info</param>
    /// <param name="species"><see cref="Species"/> ID</param>
    /// <param name="format">Form Index</param>
    /// <returns>True if has forms that can be provided by form list fetch, otherwise false for none.</returns>
