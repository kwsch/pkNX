...
public class PokeFieldObstructionWazaWildWaterEffectArchive8a : IFlatBufferArchive<PokeFieldObstructionWazaWildWaterEffect8a>
{
    public byte[] Write() => FlatBufferConverter.SerializeFrom(this);

    [FlatBufferItem(00)] public PokeFieldObstructionWazaWildWaterEffect8a[] Table { get; set; } = Array.Empty<PokeFieldObstructionWazaWildWaterEffect8a>();
}

[FlatBufferTable, TypeConverter(typeof(ExpandableObjectConverter))]
public class PokeFieldObstructionWazaWildWaterEffect8a
{
