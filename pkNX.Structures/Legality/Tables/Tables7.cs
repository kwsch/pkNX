...
public static partial class Legal
{
    ...
    public static readonly ushort[] Pouch_Items_SM = [.. Pouch_Regular_SM, .. Pouch_Ball_SM, .. Pouch_Battle_SM];
    ...
    public static readonly ushort[] Pouch_Key_USUM = [.. Pouch_Key_SM,
    ...
    public static readonly ushort[] Pouch_ZCrystal_USUM = [.. Pouch_ZCrystal_SM, // Bead
            927, 928, 929, 930, 931, 932,
        ];

    public static readonly ushort[] Pouch_ZCrystalHeld_USUM = [.. Pouch_ZCrystalHeld_SM, // Piece
    ...
    public static readonly ushort[] HeldItems_SM = [.. Pouch_Items_SM, .. Pouch_Berries_SM, .. Pouch_Medicine_SM, .. Pouch_ZCrystalHeld_SM];
    public static readonly ushort[] HeldItems_USUM = [.. Pouch_Items_SM, .. Pouch_Berries_SM, .. Pouch_Medicine_SM, .. Pouch_ZCrystalHeld_USUM, .. Pouch_Roto_USUM];
    #endregion
    ...
    public static readonly HashSet<ushort> EvolveToAlolanForms =
        [..AlolanVariantEvolutions12.Concat(AlolanOriginForms)];
    ...
    public static readonly HashSet<ushort> ValidMet_USUM =
    [
        ..ValidMet_SM, 198,
    ...
    public static readonly ushort[] HeldItemsBuy_SM = [.. Pouch_Items_SM, .. Pouch_Medicine_SM];
}
