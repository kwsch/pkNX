...
{
    public sealed partial class SWSHE : Form
    {
        ...
        public SWSHE(GameManager rom, EncounterArchive8 sym, EncounterArchive8 hid)
        {
            InitializeComponent();
            Symbols = sym;
            Hidden = hid;
        ...
        private void SWSHE_Load(object sender, EventArgs e)
        {
