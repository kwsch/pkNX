...
public static partial class Legal
{
    ...
    public static readonly int[] FinalEvolutions_7 =
    [
        .. FinalEvolutions_6,
    ...
    public static readonly int[] FinalEvolutions_8 =
    [
        .. FinalEvolutions_7,
    ...
    public static readonly int[] Legendary_SM =
    [
        .. Legendary_6,
        #region Legendary
        773, // Silvally
    ...
    public static readonly int[] Legendary_USUM = [.. Legendary_SM, 804, 805, 806]; // Poipole, Blacephalon, Stakataka

    public static readonly int[] Legendary_8 =
    [
        .. Legendary_USUM,
        #region Legendary
        888, // Zacian
    ...
    public static readonly int[] Legendary_8a = [.. Legendary_8, 905]; // Enamorus
    ...
    public static readonly int[] Mythical_SM = [.. Mythical_6, 801, 802]; // Magearna, Marshadow

    public static readonly int[] Mythical_USUM = [.. Mythical_SM, 807]; // Zeraora

    public static readonly int[] Mythical_GG = [.. Mythical_1, 809]; // Melmetal

    public static readonly int[] Mythical_8 = [.. Mythical_USUM, 809, 893]; // Melmetal, Zarude
}
