...
public partial class BaseArchiveEntry
{
    ...
    /// </summary>
    /// <remarks>
    ///The comment encoding is determined by the <c>entryNameEncoding</c> parameter of the <see cref="ZipArchive(Stream,ArchiveOpenMode,bool,Encoding?)"/> constructor.
    ...
    /// <exception cref="NotSupportedException">The ZipArchive that this entry belongs to was opened in a mode other than ArchiveMode.Update. </exception>
