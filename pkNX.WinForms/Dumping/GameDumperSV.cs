...
public class GameDumperSV
{
    ...
    private static byte[][] SerializeU16Pickle(PersonalTable9SV pt, Func<PersonalInfo9SVfb, ushort[]> sel)
    {
        var t = pt.Table;
    ...
    private static byte[][] SerializeLearnsetPickle(PersonalTable9SV pt)
    {
        ...
        static byte[] Write(IEnumerable<PersonalInfo9SVMove> fbLearnset)
        {
            using var ms = new MemoryStream();
            using var bw = new BinaryWriter(ms);
    ...
    {
        Dump<DressupStylePresetDataArray, DressupStylePresetData>("world/data/ui/dressup_preset/dressup_preset_data/dressup_preset_data_array.bfbs");
        Dump<DressupStyleDataArray, DressupStyleData>("world/data/ui/dressup_style/dressup_style_data/dressup_style_data_array.bfbs");
        Dump<DressupCategoryDataArray, DressupCategoryData>("world/data/ui/shop/dressup_shop/dressup_category_data/dressup_category_data_array.bfbs");
        Dump<DressupItemDataArray, DressupItemData>("world/data/ui/shop/dressup_shop/dressup_item_data/dressup_item_data_array.bfbs");
        Dump<DressupShopDataArray, DressupShopData>("world/data/ui/shop/dressup_shop/dressup_shop_data/dressup_shop_data_array.bfbs");
        Dump<BufDataArray, BufData>("world/data/ui/shop/shop_restaurant/restaurant_bufdata/restaurant_bufdata_array.bfbs");
        Dump<RestaurantMenuDataArray, RestaurantMenuData>("world/data/ui/shop/shop_restaurant/restaurant_menudata/restaurant_menudata_array.bfbs");
        Dump<RestaurantShopDataArray, RestaurantShopData>("world/data/ui/shop/shop_restaurant/restaurant_shopdata/restaurant_shopdata_array.bfbs");
        Dump<ShopWazamachineDataArray, ShopWazamachineData>("world/data/ui/shop/shop_wazamachine/shop_wazamachine_data/shop_wazamachine_data_array.bfbs");
    }
    ...
    private void DumpField()
    {
        ...
        Dump<GemSymbolLotteryTableArray, GemSymbolLotteryTable>("world/data/field/fixed_symbol/gem_symbol_lottery_table/gem_symbol_lottery_table_array.bfbs");
        Dump<FixedSymbolTableArray, FixedSymbolTable>("world/data/field/fixed_symbol/fixed_symbol_table/fixed_symbol_table_array.bfbs");

        Dump<ExclusionGroupArray, ExclusionGroup>("world/data/field/exclusion_area/exclusion_group_table/exclusion_group_table_array.bfbs");
        ...
        DumpSel<FixedSymbolTableArray, PokeDataSymbol>("world/data/field/fixed_symbol/fixed_symbol_table/fixed_symbol_table_array.bfbs",
            z => z.Table.Select(x => x.PokeDataSymbol), "sym");
    ...
    {
        Dump<AjitoCommonLevelArray, AjitoCommonLevel>("world/data/ajito/AjitoCommonLevel/AjitoCommonLevel_array.bfbs");
        Dump<AjitoPokemonArray, AjitoPokemon>("world/data/ajito/AjitoPokemon/AjitoPokemon_array.bfbs");
        Dump<AjitoUnitArray, AjitoUnit>("world/data/ajito/AjitoUnit/AjitoUnit_array.bfbs");
    }
    ...
    private void DumpEncount()
    {
        ...
        Dump<RaidDifficultyLotteryTableArray, RaidDifficultyLotteryTable>("world/data/encount/setting/raid_difficulty_lottery/raid_difficulty_lottery_array.bfbs");
        DumpJson<RaidGemSetting>("world/data/encount/setting/raid_gem_setting/raid_gem_setting.bfbs");
        Dump<FieldDungeonAreaArray, FieldDungeonArea>("world/data/field/area/field_dungeon_area/field_dungeon_area_array.bfbs");
        Dump<FieldInsideAreaArray, FieldInsideArea>("world/data/field/area/field_inside_area/field_inside_area_array.bfbs");
        Dump<FieldLocationArray, FieldLocation>("world/data/field/area/field_location/field_location_array.bfbs");
        Dump<FieldMainAreaArray, FieldMainArea>("world/data/field/area/field_main_area/field_main_area_array.bfbs");
        Dump<FieldSubAreaArray, FieldSubArea>("world/data/field/area/field_sub_area/field_sub_area_array.bfbs");
    ...
    {
        Dump<MapChangeParametersArray, MapChangeParameters>("world/data/field/map_change_common/map_change_common_array.bfbs");
        Dump<Structures.FlatBuffers.EventSub012.RewardTableArray, Structures.FlatBuffers.EventSub012.RewardTable>("world/data/event/sub_012/sub_012_reward/sub_012_reward_array.bfbs");
        ...
        Dump<AreaFlyFlagArray, AreaFlyFlag>("world/data/field/fly_area/area_fly_flag/area_fly_flag_array.bfbs");
        Dump<EventSkyFlyArray, EventSkyFly>("world/data/ui/map_icon_data/ui_map_icon_data/ui_map_icon_data_array.bfbs");
        Dump<NpcTrafficGenerateTableArray, NpcTrafficGenerateTable>("world/data/event/npc_traffic_generate/npc_traffic_generate_array.bfbs");
        Dump<PopupWindowTableArray, PopupWindowTable>("world/data/event/field_popup/event_field_popup/event_field_popup_array.bfbs");
        ...
        Dump<ObjectGenerationRangeArray, ObjectGenerationRange>("world/data/system/object_generation_range/object_generation_range_array.bfbs");
        Dump<BattleBgmSelectTableArray, BattleBgmSelectTable>("world/data/ui/battle_bgm_select/battle_bgm_select_data/battle_bgm_select_data_array.bfbs");
        Dump<DanQuestClearArray, DanQuestClear>("world/data/ui/quest_clear/dan_quest_clear/dan_quest_clear_array.bfbs");
        Dump<GymQuestClearArray, GymQuestClear>("world/data/ui/quest_clear/gym_quest_clear/gym_quest_clear_array.bfbs");
        Dump<NushiQuestClearArray, NushiQuestClear>("world/data/ui/quest_clear/nushi_quest_clear/nushi_quest_clear_array.bfbs");
        Dump<SystemBgArray, SystemBg>("world/data/ui/system_bg/system_bg/system_bg_array.bfbs");
        Dump<TipsDataArray, TipsData>("world/data/ui/tips/tips_data/tips_data_array.bfbs");
        Dump<NpcDestinationDataTableArray, NpcDestinationDataTable>("world/data/ui/ymap/yamp_npc_navigation_data/yamp_npc_navigation_data_array.bfbs");
        Dump<DestinationDataTableArray, DestinationDataTable>("world/data/ui/ymap/ymap_destination_data/ymap_destination_data_array.bfbs");
        Dump<PlaceNameDataTableArray, PlaceNameDataTable>("world/data/ui/ymap/ymap_place_name_data/ymap_place_name_data_array.bfbs");
    }
    ...
    {
        Dump<DeliveryRaidFixedRewardItemArray, DeliveryRaidFixedRewardItem>("world/data/raid/delivery_fixed_reward_item/delivery_fixed_reward_item_array.bfbs");
        Dump<DeliveryRaidLotteryRewardItemArray, DeliveryRaidLotteryRewardItem>("world/data/raid/delivery_lottery_reward_item/delivery_lottery_reward_item_array.bfbs");
        Dump<DeliveryRaidEnemyTableArray, DeliveryRaidEnemyTable>("world/data/raid/delivery_raid_enemy/delivery_raid_enemy_array.bfbs");
        Dump<DeliveryRaidPriorityArray, DeliveryRaidPriority>("world/data/raid/delivery_raid_priority/delivery_raid_priority_array.bfbs");
        Dump<RaidFixedRewardItemArray, RaidFixedRewardItem>("world/data/raid/raid_fixed_reward_item/raid_fixed_reward_item_array.bfbs");
        Dump<RaidLotteryRewardItemArray, RaidLotteryRewardItem>("world/data/raid/raid_lottery_reward_item/raid_lottery_reward_item_array.bfbs");
        Dump<RaidRewardSlotArray, RaidRewardSlot>("world/data/raid/raid_lottery_reward_slot/raid_lottery_reward_slot_array.bfbs");
        Dump<RaidPokeScaleDataArray, RaidPokeScaleData>("world/data/raid/raid_poke_scale/raid_poke_scale_array.bfbs");
        Dump<RaidTrainerArray, RaidTrainer>("world/data/raid/raid_trainer_01/raid_trainer_01_array.bfbs");
        Dump<RaidTrainerArray, RaidTrainer>("world/data/raid/raid_trainer_02/raid_trainer_02_array.bfbs");
        Dump<RaidTrainerArray, RaidTrainer>("world/data/raid/raid_trainer_03/raid_trainer_03_array.bfbs");
        ...
        {
            Dump<RaidEnemyTableArray, RaidEnemyTable>(f);
            static IEnumerable<PokeDataBattle> sel(RaidEnemyTableArray z) => z.Table.Select(x => x.RaidEnemyInfo.BossPokePara);
    ...
    {
        Dump<RummagingItemDataTableArray, RummagingItemDataTable>("world/data/item/rummagingItemDataTable/rummagingItemDataTable_array.bfbs");
        Dump<ItemPointTypeBiomeTableArray, ItemPointTypeBiomeTable>("world/data/item/itemPointTypeBiomeTable/itemPointTypeBiomeTable_array.bfbs");
        Dump<HiddenItemBiomeTableArray, HiddenItemBiomeTable>("world/data/item/hiddenItemBiomeTable/hiddenItemBiomeTable_array.bfbs");
        Dump<DropItemDataArray, DropItemData>("world/data/item/dropitemdata/dropitemdata_array.bfbs");
        Dump<ItemDataArray, ItemData>("world/data/item/itemdata/itemdata_array.bfbs");
        Dump<HiddenItemDataTableArray, HiddenItemDataTable>("world/data/item/hiddenItemDataTable/hiddenItemDataTable_array.bfbs");
        Dump<MonohiroiItemArray, MonohiroiItem>("world/data/item/monohiroiItemData/monohiroiItemData_array.bfbs");
    }
    ...
    private void DumpAudio()
    {
        ...
        Dump<BGMEventArray, BGMEvent>("audio/fb/bgm/bgm_event/bgm_event_array.bfbs");
    }

    private void DumpUniquePath()
    {
        Dump<ConditionSimpleAutoBattleHecklerAreaArray, ConditionSimpleAutoBattleHecklerArea>("world/data/pokemon/ai_action/trigger/condition_simple_auto_battle_heckler_area/condition_simple_auto_battle_heckler_area_array.bfbs");
        ...
        Dump<PokeObjArray, PokeObj>("world/data/pokeobj/pokeobj_param/pokeobj_param_array.bfbs");
    }

    private void DumpFieldReturn()
    {
        Dump<FieldAutomaticReturnTableArray, FieldAutomaticReturnTable>("world/data/field/area_range/field_auto_return_data/field_auto_return_data_array.bfbs");
        Dump<FieldAutoReturnPosTableArray, FieldAutoReturnPosTable>("world/data/field/area_range/field_auto_return_pos/field_auto_return_pos_array.bfbs");
        Dump<FieldOutOfRangeTableArray, FieldOutOfRangeTable>("world/data/field/area_range/field_out_of_range_data/field_out_of_range_data_array.bfbs");
    }

    private void DumpGem()
    {
        Dump<GemSettingRootTableArray, GemSettingRootTable>("world/data/gem/gem/gem_array.bfbs");
    }

    private void DumpBattle()
    {
        Dump<ItemTableArray, ItemTable>("world/data/battle/plib_item_conversion/plib_item_conversion_array.bfbs");
        Dump<PokeExceptionTableArray, PokeExceptionTable>("world/data/battle/pokeExceptionTable/pokeExceptionTable_array.bfbs");
        DumpJson<BattleConfig>("world/data/battle/battleconfig/battleconfig.bfbs");
        Dump<EventBattlePokemonArray, EventBattlePokemon>("world/data/battle/eventBattlePokemon/eventBattlePokemon_array.bfbs");
        Dump<BattleEffectTableArray, BattleEffectTable>("world/data/battle/battleeffecttable/battleeffecttable_array.bfbs");
    ...
    {
        Dump<BlacklistArray, Blacklist>("world/data/ui/pokedex/blacklist/blacklist_array.bfbs");
        Dump<MemoPokeTableArray, MemoPokeTable>("world/data/ui/pokedex/memo_poke_data/memo_poke_data_array.bfbs");
        Dump<RewardDataArray, RewardData>("world/data/ui/pokedex/reward_data/reward_data_array.bfbs");

        DumpX<DistributionRootArray, DistributionRoot, DistributionData>("world/data/ui/pokedex/distribution_data/distribution_data_array.bfbs");
    }

    private void DumpUI()
    {
        Dump<ShopDataArray, ShopData>("world/data/ui/shop/shop_data/shop_data_array.bfbs");
        Dump<RibbonDataArray, RibbonData>("world/data/ui/status/ribbon/ribbon_array.bfbs");

        Dump<FriendlyShopDataArray, FriendlyShopData>("world/data/ui/shop/friendlyshop/friendlyshop_data/friendlyshop_data_array.bfbs");
        Dump<LineupDataArray, LineupData>("world/data/ui/shop/friendlyshop/friendlyshop_lineup_data/friendlyshop_lineup_data_array.bfbs");
        Dump<SchoolMapDataArray, SchoolMapData>("world/data/ui/schoolmap/schoolmap_data/schoolmap_data_array.bfbs");
    }

    private void DumpNetBattle()
    {
        Dump<NetBattleRuleDataArray, NetBattleRuleData>("world/data/ui/net_battle/net_battle_rule_data/net_battle_rule_data_array.bfbs");
        Dump<NetBattleRuleParamArray, NetBattleRuleParam>("world/data/ui/net_battle/net_battle_rule_param/net_battle_rule_param_array.bfbs");
    }

    public void DumpTrainers()
    {
        Dump<TrDataMainArray, TrDataMain>("world/data/trainer/trdata/trdata_array.bfbs");
        Dump<TrainerEnvArray, TrainerEnv>("world/data/trainer/trenv/trenv_array.bfbs");
        Dump<TrainerTypeArray, TrainerType>("world/data/trainer/trtype/trtype_array.bfbs");
        DumpX<TrDataMainArray, TrDataMain, PokeDataBattle>("world/data/trainer/trdata/trdata_array.bfbs");
    }
    ...
    public void DumpCooking()
    {
        ...
        Dump<FoodPowerComboArray, FoodPowerCombo>(fpc);
        Dump<IngredientDataArray, IngredientData>(ipc);
        Dump<IngredientDishDataArray, IngredientDishData>("world/data/cooking/Ingredient/IngredientDishData/IngredientDishData_array.bfbs");
        Dump<RecipeDataArray, RecipeData>("world/data/cooking/Recipe/RecipeData/RecipeData_array.bfbs");
        Dump<SeasoningDataArray, SeasoningData>("world/data/cooking/Seasoning/SeasoningData/SeasoningData_array.bfbs");
        ...
        foreach (var lang in LanguageEnglishNames)
        {
            ...
            foreach (var entry in table)
            {
                ...
                if (param.Ingredient0 != IngredientType.NONE) ts.Write($"{param.Ingredient0}, ");
                if (param.Ingredient1 != IngredientType.NONE) ts.Write($"{param.Ingredient1}, ");
                if (param.Ingredient2 != IngredientType.NONE) ts.Write($"{param.Ingredient2}, ");
                if (param.Ingredient3 != IngredientType.NONE) ts.Write($"{param.Ingredient3}, ");
                if (param.Ingredient4 != IngredientType.NONE) ts.Write($"{param.Ingredient4}, ");
                if (param.Ingredient5 != IngredientType.NONE) ts.Write($"{param.Ingredient5}, ");
                ts.WriteLine();
                // Write the seasonings in a single line.
                if (param.Seasoning0 != SeasoningType.NONE) ts.Write($"{param.Seasoning0}, ");
                if (param.Seasoning1 != SeasoningType.NONE) ts.Write($"{param.Seasoning1}, ");
                if (param.Seasoning2 != SeasoningType.NONE) ts.Write($"{param.Seasoning2}, ");
                if (param.Seasoning3 != SeasoningType.NONE) ts.Write($"{param.Seasoning3}, ");
                ts.WriteLine();
    ...
    {
        Dump<EventTradeListArray, EventTradeList>("world/data/event/eventTradeList/eventTradeList_array.bfbs");
        Dump<EventTradePokemonArray, EventTradePokemon>("world/data/event/eventTradePokemon/eventTradePokemon_array.bfbs");
        ...
        where TSub : class
    {
        ...
        for (int i = 0; i < flat.Table.Length; i++)
        {
            var entry = flat.Table[i].Table;
    ...
    private void DumpPackedFile(string f)
    {
        ...
        if (ext == ".bfbs")
            HandleReflection(data, path, dir);
    }
    ...
    private static void HandleReflection(byte[] data, string filePath, string dir)
    {
        var schema = FlatBufferConverter.DeserializeFrom<ReflectionSchema>(data);
        var rootName = schema.RootTable?.Name ?? Path.GetFileNameWithoutExtension(filePath);
        var fileName = Path.Combine(dir, $"{rootName}.cs");
        using var fs = File.Create(fileName);
        using var text = new StreamWriter(fs);
        ReflectionDumper.DumpSchema(schema, text);
        DumpJson(schema, filePath + ".json");
    }
