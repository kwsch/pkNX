...
/// </summary>
public sealed class PersonalInfo9SV : IPersonalInfoSV
{
    public PersonalInfo9SVfb FB { get; }

    public PersonalInfo9SV(PersonalInfo9SVfb fb) => FB = fb;
    ...
    public int GenderGroup { get => FB.Gender.Group; set => FB.Gender.Group = (byte)value; }
    public int GenderRatio { get => FB.Gender.Ratio; set => FB.Gender.Ratio = (byte)value; }
    public int Gender
    {
    ...
    public int DexGroup
    {
        ...
        set
        {
            if (value == 0)
                ...
                (FB.Dex ??= new PersonalInfo9SVDex()).Group = (byte)value;
        }
    }
    public int DexIndex
    {
        ...
        set
        {
            if (value == 0)
                ...
                (FB.Dex ??= new PersonalInfo9SVDex()).Index = (byte)value;
        }
    }
